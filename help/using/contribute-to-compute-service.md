...
* Feedback geben: Erstellen Sie ein GitHub-Problem im entsprechenden Repository, um Fehler in Produkten oder in der Dokumentation zu melden oder Verbesserungen und neue Funktionen anzufordern. Nicht sicher, welches Repository Sie zum Einsenden Ihres Problems verwendet sollen? Sollte dies der Fall sein, melden Sie das Problem im [Asset Compute SDK-Repository](https://github.com/adobe/asset-compute-sdk). Es wird dann entsprechend weitergeleitet.
